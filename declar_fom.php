...
<script type="text/javascript" src="https://indovisionservices.in/info/dev/v15/inc/bs/bootstrap-select.min.js">
 /* $(document).ready(function(){

    var html = '<tr><td><input class="form-control" type="text" name="name1" 
     required=""></td><td><input class="form-control" type="Date" name="date1"
     required=""></td><td><input class="form-control" type="text" name="relation_per" 
     required=""></td><td><input class="form-control" type="text" name="residing"
     required=""></td><td><input class="form-control" type="text" name="places" 
...
<body>
 ...
 <div id="div1">
  ...
  <br>
    <div id="div3">
    <table class="table table-bordered">
    <h5>(c) Details of the nominee u/s 71 of ESI Act1948 / Rule 56(2) of ESI (Central) Rules 1950 for payment of cash benefit in the event of death</h5>
    <thead>
    <tr>
    ...
    <br><br>
	<h4>(D) FAMILY PARTICULARS OF INSURED PERSON</h4>	<div id="div6" class="input-field">
  ...
  <tr>
   <td><input class="form-control" type="text" name="name1[]" ></td>
    ...
    <td><input class="form-control" type="text" name="relation_per[]"></td>
    <td><input class="form-control" type="text" name="residing[]"></td>
    <td><input class="form-control" type="text" name="places[]"></td>
    </tr> 
<?php } ?>
