...
<body>
 ...
 <div id="div1">
  ...
  <br>
    ...
    <?php for($j=1; $j<6; $j++ ){ ?>
  <tr>
   <td><input class="form-control" type="text" name="name1[]" required=""></td>
    <td><input class="form-control" type="Date" name="date1" required=""> </td>
    <td><input class="form-control" type="text" name="relation_per" required=""></td>
    <td><input class="form-control" type="text" name="residing" required=""></td>
    <td><input class="form-control" type="text" name="places" required=""></td>
    </tr> 
<?php } ?>
